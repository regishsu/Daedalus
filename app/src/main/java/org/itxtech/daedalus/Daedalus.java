...
public class Daedalus extends Application {
    ...
    public static final List<DnsServer> DNS_SERVERS = new ArrayList<DnsServer>() {{
        ...
        add(new DnsServer("1.1.1.1", R.string.server_cloudflare_udp));
        add(new DnsServer("1.0.0.1", R.string.server_cloudflare_udp_secondary));
        add(new DnsServer("1.1.1.1/dns-query", R.string.server_cloudflare_doh));
        add(new DnsServer("8.8.8.8", R.string.server_google_udp));
        add(new DnsServer("8.8.4.4", R.string.server_google_udp_secondary));
        add(new DnsServer("9.9.9.9", R.string.server_quad9_udp));
        add(new DnsServer("9.9.9.9/dns-query", R.string.server_quad9_doh));
        add(new DnsServer("208.67.222.222", R.string.server_opendns));
        add(new DnsServer("208.67.220.220", R.string.server_opendns_secondary));
        add(new DnsServer("94.140.14.14", R.string.server_adguard_udp));
        add(new DnsServer("dns.adguard.com/dns-query", R.string.server_adguard_doh));
        add(new DnsServer("223.5.5.5", R.string.server_alidns));
        add(new DnsServer("119.29.29.29", R.string.server_dnspod));
    }};
